...
func HandleAdminCommand(
	...
	case "help", "commands", "اوامر", "أوامر":
		if !isAdmin {
			return CommandResult{
				Handled: true,
				ReplyText: "🤖 *أوامر مسابقات وتفاعل نوفا (500 سؤال):*\n\n" +
					"• `/game` : بدء مسابقة كوكتيل عشوائي 🎮\n" +
					"• `/game christian` أو `/game مسيحي` : مسابقة الكتاب المقدس والتاريخ الكنسي ✝️\n" +
					"• `/game quote` أو `/game افيهات` : مسابقة إفيهات السينما والمسرحيات المصرية 🎭\n" +
					"• `/game movie` أو `/game سينما` : مسابقة أفلام وفنون 🎬\n" +
					"• `/game ball` أو `/game كورة` : مسابقة كورة القدم والرياضة ⚽\n" +
					"• `/game amthal` أو `/game امثال` : مسابقة كمّل المثل الشعبي 📜\n" +
					"• `/game trivia` أو `/game عامة` : ثقافة عامة وجغرافيا وعواصم 🧠\n" +
					"• `/game riddle` أو `/game فوازير` : فوازير وألغاز ذكاء 🧩\n" +
					"• `/game science` أو `/game علوم` : علوم وتكنولوجيا وفضاء 🔬\n" +
					"• `/game history` أو `/game تاريخ` : تاريخ وحضارات وفراعنة 🏛️\n" +
					"• `/game cartoon` أو `/game كرتون` : كرتون وأنمي وسبيستون 🎨\n" +
		...
		helpMsg := "👑 *دليل أوامر الإدارة الشامل لبوت نوفا (Nova Admin Commands):*\n\n" +
			...
			"🎮 *الألعاب والمسابقات (500 سؤال + منع التكرار):*\n" +
			"• `/game` : بدء مسابقة كوكتيل عشوائي\n" +
			"• `/game <christian|quote|movie|ball|amthal|trivia|riddle|science|history|cartoon>` : اختيار القسم\n" +
